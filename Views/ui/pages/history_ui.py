...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.deleteButton = QtWidgets.QPushButton(parent=self.headerFrame)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Fixed, QtWidgets.QSizePolicy.Policy.Maximum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.historyScrollArea = QtWidgets.QScrollArea(parent=Form)
        ...
        self.historyWidgetsLayout = QtWidgets.QVBoxLayout()
        self.historyWidgetsLayout.setObjectName("historyWidgetsLayout")
        self.verticalLayout_2.addLayout(self.historyWidgetsLayout)
        self.historyScrollArea.setWidget(self.scrollAreaWidgetContents)
        self.verticalLayout_3.addWidget(self.historyScrollArea)
    ...
    def retranslateUi(self, Form):
        ...
        self.pageLabel.setText(_translate("Form", "История"))
        self.deleteButton.setText(_translate("Form", "очистить"))
